...
export function ConfluenceWeekPage() {
  ...
  useEffect(() => {
    ...
    const loadDocs = async () => {
      ...
      try {
        const result = await fetchArtifacts(startDate, endDate, ['confluence']);
  ...
  const handleBackToMonth = () => {
    if (startDate) {
      ...
      navigate(`/confluence/month/${year}/${month}`);
    }
  };
